...
- IMPORTANTE: IL CAMPO DEL BASE 64 DEI DOCUEMNTI ALL INTERNO DELL ITEM E' SATTO POPOLATO CON IL PATH DEL FILE ASSOCIATO, DUQNUE PER LEGGERNE IL CONTENUTO (FILE PDF) DEVI USARE APPOSITO STRUMENTO FORNENDO IL PATH ASSOLUTO IN INPUT! SE CI SONO DOCUEMNTI ASSOCIATI ALL ITEM DOVRAI SEMPRE LEGGERLI OGNI VOLTA!
- USA STRUMENTO PER LEGGERE FILE TUTTE LE VOLTE CHE PUOI!
"""
    chat_history = []
